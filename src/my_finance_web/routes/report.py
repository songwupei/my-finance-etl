...
from ...my_finance_shared import GENERATED_REPORTS_DIR, PYBOX_DIR
...
def generate_report():
    ...
    qmd_template = GENERATED_REPORTS_DIR / "daily_report_account-gb.qmd"
    ...
    cmd = [
        ...
        f"export PYTHONPATH={PYBOX_DIR}:${{PYTHONPATH:-}} && cd {GENERATED_REPORTS_DIR} && quarto render daily_report_account-gb.qmd -P year:{year} -P month:{month} -P day:{day}"
    ]

    try:
        subprocess.run(cmd, capture_output=True, text=True, check=True)
        quarto_pdf = GENERATED_REPORTS_DIR / "daily_report_account-gb.pdf"
        ...
        quarto_docx = GENERATED_REPORTS_DIR / "daily_report_account-gb.docx"
